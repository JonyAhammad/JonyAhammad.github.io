...
<title>Jony Ahammad - Centria</title>
<!-- Load Tailwind CSS -->
...
<div class="profile-pic-placeholder rounded-full flex items-center justify-center mb-6 text-2xl font-bold text-accent">JonyAhammad_centria_student</div>
...
<p>&copy; 2025 Jony Ahammad. All rights reserved. | <span class="text-accent">Web Portfolio v3.0 - Single File Solution</span></p>
</div>
</footer>
